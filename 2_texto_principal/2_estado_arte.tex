...
\label{chap:2:sec:1}
A geração actual de casas inteligentes tem tido uma maior evolução na inteligência artificial num sistema centralizado, em detrimento dos sistemas de monitorização e controlo. A casa inteligente actual consiste em vários electrodomésticos e outros dispositivos, com sensores, actuadores e/ou monitores biomédicos, usados pelos residentes numa base diária. Em alguns casos a casa é inteiramente monitorizada recorrendo a tecnologias áudio-visuais. Estes sistemas apresentam uma excelente forma de monitorização mas têm algumas desvantagens:
...
\subsection{Monitorização Vídeo e Áudio}
