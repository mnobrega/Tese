...
\item Monitorização com com sensores doméstico.
\end{itemize}
...
\item Problemas de aceitação da nova tecnologia por parte dos idosos, visto que estes têm tendência a esconder muitas vezes informação com receio de ir para a um lar de idosos;
\end{itemize}
