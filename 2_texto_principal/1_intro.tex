...
\begin{itemize}
\item Propõe um sistema simulado de monitorização de pessoas em ambiente doméstico;
...
No \autoref{chap:6} são feitos testes num cenário construído para o efeito, analisando os efeitos produzidos pelas técnicas de centro de massa e média espaço-temporal usadas na estimação de espaço contínuo.

No \autoref{chap:7} faz-se a conclusão deste trabalho e identificam-se algumas ideias para trabalho futuro.
