...
\begin{table}[!htb]
  ...
  \caption{Índice de independência nas \acsp{ADL} \cite{17}.}
  \label{tab:1:adls}
\end{table}
...
\begin{table}[!htb]
  ...
  \caption{Classificação das \acsp{ADL} por importância, dificuldade em monitorizar e top 10 das mais úteis \cite{16}.}
