...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.8\textwidth]{img/04_framework_overview.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.8\textwidth]{img/04_omnet.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.9\textwidth]{img/04_omnet_internal.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.85\textwidth]{img/04_mixim_node_module.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.90\textwidth]{img/04_mixim_logic_layers.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.90\textwidth]{img/04_mixim_phy.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.90\textwidth]{img/04_mixim_with_obstacles.png}
...
onde \begin{math}P\end{math} é potência, \begin{math}G\end{math} é ganho e \begin{math}L_x\end{math} são os termos que traduzem as perdas. No MiXiM as perdas já são calculadas como descrito na secção anterior pela camada \acs{PHY} mas não contemplam as perdas provocadas por obstáculos. 

É então sugerido um termo para a potência provocada por obstáculos:
