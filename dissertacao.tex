...
\input{1_capa-resumo-indice/1_capa}
...
\input{1_capa-resumo-indice/4_indice}

% Pages number is starting now with arabic style... until now it was on roman mode
\setcounter{page}{1} \pagenumbering{arabic}
\baselineskip 18pt

\input{2_texto_principal/1_intro}

\input{2_texto_principal/2_estado_arte}

\input{2_texto_principal/3_trabalho1}

\input{2_texto_principal/4_trabalho2}

\input{2_texto_principal/5_trabalho3}

\input{2_texto_principal/6_conclusoes}

\input{3_referencias-anexos/1_refs}

\input{3_referencias-anexos/2_anexos}
